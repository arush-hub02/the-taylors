...
export default function ProductDetails() {
  ...
  return (
    <div className="bg-white lg:px-20 px-3 ">
      <div className="pt-6">
        ...
        <section className="pt-10">
          <h1 className="py-5 pl-5 text-xl font-bold">Similar Products</h1>
          <div className="flex flex-wrap space-y-5 justify-center">
            {mens_kurta.slice(0, 6).map((item) => (
              <HomeProductCard product={item} />
            ))}
          </div>
          <div className="flex flex-wrap space-y-5 mt-7  justify-center">
            {mensShoesPage1.slice(0, 6).map((item) => (
              <HomeProductCard product={item} />
            ))}
          </div>
        </section>
